...
const cardText = [
  `Bacheloroppgaven min undersøkte hvordan blokkjede-teknologi kan brukes til å utstede og verifisere utdanningsvitnemål på en sikker og effektiv måte. Prosjektet kombinerte teoretisk forskning med et praktisk proof-of-concept utivklet i et smartkontraktspråk kalt Daml. Oppgaven dekker personvern- og sikkerhetshensyn, med mål om effektivisering og reduksjon av forfalskede vitnemål. Kan lastes ned her ${dwnlBcl}`,
  "Dette prosjektet er nettsiden du befinner deg på. En demonstrasjon av mine ferdigheter innen moderne webutvikling. Nettsiden er bygget med React og JavaScript, og inneholder dynamiske komponenter, responsivt design og optimalisert bilde- og innholdsstruktur. Den er hostet på Azure Static Web Apps. Layout og design er laget i Figma, med fokus på klar visuell profil og brukervennlighet.",
